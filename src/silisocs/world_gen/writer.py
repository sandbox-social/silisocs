...
def write_world(spec: WorldSpec, root: Path | str) -> None:
    """write_world.

    :param WorldSpec spec:
    :type spec: WorldSpec
    :param Path | str root:
    :type root: Path | str
...
def _write_world_yaml(spec: WorldSpec, conf: Path) -> None:
    """_write_world_yaml.
...
def _write_agents_yaml(spec: WorldSpec, conf: Path) -> None:
    """_write_agents_yaml.
...
def _write_env_yaml(spec: WorldSpec, conf: Path) -> None:
    """_write_env_yaml.
