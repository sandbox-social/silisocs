...
from silisocs.runtime.agent_building import build_agent_configs

# Local imports
from silisocs.runtime.config import ConfigStore, validate_scenario_config
from silisocs.runtime.dataclasses import (
    GameMasterConfig,
    InitializerConfig,
    InitializerParams,
    SimRole,
)
from silisocs.runtime.factories import build_engine, default_gm_filename, default_gm_module_path
from silisocs.runtime.projection import RuntimeProjection
from silisocs.runtime.simulation import Simulation
from silisocs.utils.media import select_large_language_model
from silisocs.utils.misc import (
    SimMetricsCollector,
    configure_logging,
    get_prefab_instance,
...
def _build_action_prompt(
    ...
    from silisocs.runtime.action_prompts import build_action_prompt_with_app_instance
...
def build_game_masters(cfg: DictConfig) -> list[prefab_lib.InstanceConfig]:
    ...
    initializer_module_path = "silisocs.agents.initialization.formative"
    if processing_mode == "raw":
        initializer_prefab = "raw_memories_initializer__GameMaster"
        initializer_module_path = "silisocs.agents.initialization.raw"
...
def _inject_external_config_path() -> None:
    ...
    point), which reads ``SILISOCS_EXTERNAL_CONFIG_DIRS`` and prepends
