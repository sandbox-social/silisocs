"""Advanced multi-GM social media engine with external GM sequencing.
...
from mastodon_sim.environments.engines.social_media import FlowSocialMediaEngine
from mastodon_sim.runtime.config import ConfigStore

_LOGGER = logging.getLogger(__name__)


class MultiGMSocialMediaEngine(FlowSocialMediaEngine):
    """Advanced engine supporting multiple game masters with explicit sequencing.

    This engine extends FlowSocialMediaEngine to support advanced scenarios where:
    ...
    Usage in configuration:
        ...
        engine:
          class: MultiGMSocialMediaEngine
    ...
    def run_episode(
        ...
        Otherwise, falls back to standard FlowSocialMediaEngine behavior.
        """
        ...
        # The parent FlowSocialMediaEngine already supports multiple GMs via
