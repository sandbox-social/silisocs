...
from mastodon_sim.environments.backends.base import (  # noqa: F401 – re-exported for backward compat
    COLOR_TYPE,
    ActionArgumentError,
    ActionDescriptor,
    Parameter,
...
from mastodon_sim.environments.backends.mastodon.mastodon_ops import (
    check_env,
    ...
    def initialize(self, agent_names: list[str], **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: ``sim_roles``, ``seed_posts``, ``social_network``,
                ``agent_bios``.
        """
        from mastodon_sim.utils.network import generate_follow_network
