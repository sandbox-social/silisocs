...
def load_both_groups() -> list[dict[str, Any]]:
    ...
    """
    conservative_path = '/scratch/ss14247/oasis/data/twitter_dataset/group_polarization/197_baoshou.csv'
    progressive_path = '/scratch/ss14247/oasis/data/twitter_dataset/group_polarization/197_progressive.csv'
...
def get_agent_counts() -> dict[str, int]:
    ...
    counts = {}
    with open(conservative_path, 'r', encoding='utf-8') as f:
        counts['conservative'] = sum(1 for _ in csv.DictReader(f))

    with open(progressive_path, 'r', encoding='utf-8') as f:
