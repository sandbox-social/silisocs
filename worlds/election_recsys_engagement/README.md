...
Same as `election` (Storhampton mayoral race) — see `worlds/election/README.md`.
...
```bash
uv run silisocs --config-path worlds/election_recsys_engagement/conf num_steps=15
```
