...
experiments/
  ...
  studies/
    {study_name}/
      ...
      generated/                        # Reproducibility locks, eval copies, summaries
      {hypothesis_id}/
...
5. Run `uv run python -m experiments.run_study --study experiments/studies/{study_name} organize` to rebuild the organized tree.
